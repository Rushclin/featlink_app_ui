...
class SwipezoneFullScreenModalAfricaScreen extends StatefulWidget {
  @override
  State<SwipezoneFullScreenModalAfricaScreen> createState() =>
      _SwipezoneFullScreenModalAfricaScreenState();
}

class _SwipezoneFullScreenModalAfricaScreenState
    extends State<SwipezoneFullScreenModalAfricaScreen> {
  int _current = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet: const AppNavigationBottomSheet(),
    );
  }
}
